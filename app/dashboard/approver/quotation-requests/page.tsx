  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col justify-between gap-3 md:flex-row md:items-center">
        <div>
          <h2 className="text-2xl font-semibold tracking-tight text-gray-900">Quotation Request History (View Only)</h2>
        </div>
              ...
              <tbody>
                {filteredQrs.map((qr) => {
                  ...
                  >
                    ...
                    <td className="px-3 py-3 align-top text-right text-gray-500 text-[10px] leading-relaxed">
